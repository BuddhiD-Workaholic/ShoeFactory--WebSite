...
<body>
  ...
  <br>
  <center><h3 style=" margin:0px 0px 20px 0px; font-size: 28px;">Order Tracking</h3></center>
		<table width="1149" height="126" border="1" id="customersData">
			<tbody>
				<tr>
					<th width="54">Product Name</th>
					<th width="86">Brand Name</th>
					<th width="86">Price</th>
					<th width="86">Product Image</th>
          			<th width="86">Order Tracking Status</th>
				</tr>
				<tr>
					<?php
					...
					if (mysqli_num_rows($result0) > 0) {
						while ($re = mysqli_fetch_assoc($result0)) {
							...
							echo "<tr><b><td><b>Order ID: </b>" .  $re['Order_ID'] . "</td><td><b>Total Payment: </b>Rs: " .  $re['PayAmount'] . ".00</td><td><b>Order Date: </b>" . $re['OrderDate'] . "</td><td><b>Shipping Date: </b>" . $re['ShippingDate'] . "</td><td><b>".$re['OrdertrackingStatus']."</b></td></tr>";
							if (mysqli_num_rows($result) > 0) {
								while ($Fed = mysqli_fetch_assoc($result)) {
									...
									if (mysqli_num_rows($result2) > 0) {
										...
										echo "<tr><td>" . $ProdData["PName"] . "</td><td>" . $ProdData["BrandName"] . "</td><td>Rs: " . $ProdData["Price"] . ".00</td><td> <center><img width='100px' height='120px' src='" . $ProdData["MainImg"] . "'></center> </td><td></td></tr>";
									}
								}
							}
						}
